import{j as e,l as b,R as p,f7 as L,a as F,T as x,I as $,k as Ce,r as R,aO as O,s as U,q as Te,a9 as we,fM as ve,c3 as Y,a6 as ee,bc as W,fN as ke,n as te,bQ as $e,bi as Me,bk as De,c_ as Re,bz as Ae,aM as Se,K as Fe,bV as ne,E as P,dp as Ie,Z as Ee,A as Oe,fr as Le,bD as Ne,aU as V,fO as Ue,L as oe}from"./strapi-BlY_cdIW.js";import{u as M,g as m,C as J,a as H,A as Pe,S as Be,c as Q,b as ie}from"./index-CKoWMGm-.js";import{d as ze,e as X,D as Ve,f as Ze,a as We,S as He,v as qe,s as Ke,K as _e,P as Ge,c as Je,C as Qe}from"./sortable.esm-BrhCgQ7H.js";import"./index-BFAaf0Vf.js";import"./groupBy-DQZk0Qkd.js";import"./_baseEach-D1a0KXUJ.js";import"./sortBy-YBQEGCdg.js";import"./_baseMap-KG10PMeK.js";import"./index-j_XcYY9U.js";import"./index-BRVyLNfZ.js";const Xe=t=>{let{transform:n}=t;return{...n,x:0}},Ye=b(p)`
  position: absolute;
  left: -3.4rem;
  top: 0px;
...
`,mt=({uid:t})=>{const{components:n}=M(),o=L(n,t);return e.jsxs(e.Fragment,{children:[" (",e.jsx(Y,{onClick:s=>s.stopPropagation(),tag:ee,to:`/plugins/content-type-builder/component-categories/${o.category}/${o.uid}`,children:W(o.info.displayName)}),")"]})},de=b(p)`
  height: 2.4rem;
  width: 2.4rem;
  border-radius: 50%;
  display: flex;
...
`,Tt=R.memo(({disabled:t,type:n})=>{const{formatMessage:o}=F(),s=Ee(),a=yt(n),l=o({id:"content-type-builder.form.button.configure-view",defaultMessage:"Configure the view"}),i=()=>{if(t)return!1;const y=jt(n);return s(y),!1},{isLoading:c,allowedActions:f}=Oe(a);return c||!f.canConfigureView&&!f.canConfigureLayout?null:e.jsx(Ct,{startIcon:e.jsx(Le,{}),variant:"tertiary",onClick:i,disabled:t,children:l})}),wt=b(oe.Header)`
  ...
  white-space: nowrap;
`,Et=()=>{const{isInDevelopmentMode:t,contentTypes:n,components:o,isLoading:s}=M(),{formatMessage:a}=F(),{trackUsage:l}=ie(),{contentTypeUid:i,componentUid:c}=Ne(),{onOpenModalAddComponentsToDZ:f,onOpenModalAddField:y,onOpenModalEditSchema:k}=H(),r=i?n[i]:c?o[c]:null;if(s)return null;if(!r){const j=Object.values(n).filter(C=>C.visible===!0&&!C.plugin).map(C=>C.uid).sort();return j.length>0?e.jsx(V,{to:`/plugins/content-type-builder/content-types/${j[0]}`}):e.jsx(V,{to:"/plugins/content-type-builder/content-types/create-content-type"})}if(i&&r.modelType==="contentType"&&r.visible===!1)return e.jsx(V,{to:"/plugins/content-type-builder/content-types/create-content-type",replace:!0});const d="plugin"in r&&r?.plugin!==void 0,u=i?"contentType":"component",T=r?.info?.displayName??"",w=t&&!d,A=j=>{f({dynamicZoneTarget:j,targetUid:r.uid})},D=()=>{if("kind"in r){r?.kind==="collectionType"&&l("willEditNameOfContentType"),r?.kind==="singleType"&&l("willEditNameOfSingleType"),k({modalType:u,forTarget:u,targetUid:r.uid,kind:r?.kind});return}k({modalType:u,forTarget:u,targetUid:r.uid})},I=a({id:m("table.button.no-fields"),defaultMessage:"Add new field"}),S=a({id:m("button.attributes.add.another"),defaultMessage:"Add another field"}),g=r.status==="REMOVED",h=t&&e.jsxs(x,{gap:2,children:[e.jsx(Tt,{type:r,disabled:r.status==="NEW"||g},"link-to-cm-settings-view"),e.jsx(P,{startIcon:e.jsx(te,{}),variant:"tertiary",onClick:D,disabled:!w||g,children:a({id:"app.utils.edit",defaultMessage:"Edit"})}),e.jsx(P,{startIcon:e.jsx(O,{}),variant:"secondary",minWidth:"max-content",onClick:()=>{y({forTarget:u,targetUid:r.uid})},disabled:g,children:r.attributes.length===0?I:S})]});return e.jsxs(e.Fragment,{children:[e.jsx(ne.contentTypeBuilder.Introduction,{children:e.jsx(p,{})}),g&&e.jsx(x,{background:"danger100",justifyContent:"center",padding:4,children:e.jsxs(x,{gap:2,children:[e.jsx(Ue,{fill:"danger600",height:"2rem",width:"2rem"}),e.jsx($,{children:a({id:m("table.warning.deleted"),defaultMessage:"This {kind} has been deleted"},{kind:r.modelType==="contentType"?"Content Type":"Component"})})]})}),e.jsx(wt,{id:"title",primaryAction:h,title:W(T)}),e.jsx(oe.Content,{children:e.jsx(p,{background:"neutral0",shadow:"filterShadow",hasRadius:!0,overflow:"auto",borderColor:"neutral150",children:e.jsx(ue,{type:r,addComponentToDZ:A,isMain:!0})})})]})};export{Et as default};
