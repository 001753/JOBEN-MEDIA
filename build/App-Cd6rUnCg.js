...
`,Vs=m(b)`
  flex: 1;
  min-width: 0;
`,Ws=({asset:e,onAssetItemClick:n})=>{const{formatMessage:s}=I(),r=se(e.mime,e.ext),o=a=>{(a.key==="Enter"||a.key===" ")&&(a.preventDefault(),n(e.id))};return t.jsxs(Es,{tabIndex:0,role:"listitem",onClick:()=>n(e.id),onKeyDown:o,children:[t.jsx(Gs,{children:t.jsx(_s,{asset:e})}),t.jsx(zt,{children:t.jsxs(Bs,{alignItems:"center",gap:2,children:[t.jsx(Us,{children:t.jsx(r,{width:20,height:20})}),t.jsx(Vs,{textColor:"primary800",ellipsis:!0,children:e.name}),t.jsx(B,{label:s({id:f("control-card.more-actions"),defaultMessage:"More actions"}),variant:"ghost",children:t.jsx(fe,{})})]})})]})},Hs=({assets:e,folders:n=[],onAssetItemClick:s})=>{const{formatMessage:r}=I();return n.length+e.length===0?t.jsx(S,{padding:8,children:t.jsx(b,{textColor:"neutral600",children:r({id:"app.components.EmptyStateLayout.content-document",defaultMessage:"No content found"})})}):t.jsxs(ae.Root,{gap:4,role:"list",children:[n.length>0&&t.jsx(As,{children:t.jsx(ae.Root,{gap:4,children:n.map(a=>t.jsx(ae.Item,{col:3,m:4,s:6,xs:12,children:t.jsx(Ps,{folder:a})},`folder-${a.id}`))})}),e.map(a=>t.jsx(ae.Item,{col:3,m:4,s:6,xs:12,direction:"column",alignItems:"stretch",children:t.jsx(Ws,{asset:a,onAssetItemClick:s})},a.id))]})},zs={view:"STRAPI_UPLOAD_LIBRARY_VIEW"},J={GRID:0,TABLE:1},ke=[{name:"name",label:{id:f("list.table.header.name"),defaultMessage:"name"}},{name:"createdAt",label:{id:f("list.table.header.creationDate"),defaultMessage:"creation date"}},{name:"updatedAt",label:{id:f("list.table.header.lastModified"),defaultMessage:"last modified"}},{name:"size",label:{id:f("list.table.header.size"),defaultMessage:"size"}},{name:"actions",label:{id:f("list.table.header.actions"),defaultMessage:"actions"},isVisuallyHidden:!0}],qs=m(Zt)`
  width: 100%;
